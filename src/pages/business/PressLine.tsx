...
export const PressLine = () => {
    ...
    // Dynamic access to translation keys
    const activeProduct = {
        ...activeProductRaw,
        name: t(`business_pages.press.products.${activeProductRaw.titleKey}.name`),
        subtitle: t(`business_pages.press.products.${activeProductRaw.titleKey}.subtitle`),
        description: t(`business_pages.press.products.${activeProductRaw.titleKey}.desc`),
        specs: t(`business_pages.press.products.${activeProductRaw.titleKey}.specs`, { returnObjects: true }) as { label: string; value: string }[],
        features: t(`business_pages.press.products.${activeProductRaw.titleKey}.features`, { returnObjects: true }) as string[],
        options: t(`business_pages.press.products.${activeProductRaw.titleKey}.options`, { returnObjects: true }) as string[]
    };
        ...
        <div className="bg-white min-h-screen pt-20">
            ...
            <div className="bg-gray-950 text-white py-20 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        <h1 className="text-4xl md:text-6xl font-bold mb-6">{t('business_pages.press.title')}</h1>
                        <p className="text-gray-400 text-xl max-w-2xl whitespace-pre-line">
                            {t('business_pages.press.subtitle')}
                        </p>
                    </motion.div>
                </div>
            </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="flex overflow-x-auto no-scrollbar gap-2 py-4">
                        {products.map((product) => {
                            const productName = t(`business_pages.press.products.${product.titleKey}.name`);
                            return (
                                <button
                                    key={product.id}
